...
const RoomSelector = ({ form: { values, setFieldValue } }) => {
  // console.log(values)
          ...
          <>
            <div className="header">
              <div className="row room-content">
                <div className="col-6">
                  <div className="occupancy-room">rooms</div>
                </div>
                <div className="col-6">
                  <div className="number">
                    ...
                    <div>{values.occupancy.length}</div>
                    <div>
                      <i
                        id="plus"
